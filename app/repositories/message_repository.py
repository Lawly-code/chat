...
class MessageRepository(BaseRepository):
    ...
    async def get_ai_messages(
        ...
        query = select(Message).where(
            Message.user_id == user_id, Message.chat_type == ChatTypeEnum.AI
        )
    ...
    async def get_lawyer_messages(
        ...
        """
        query = select(Message).where(
            Message.user_id == user_id, Message.chat_type == ChatTypeEnum.LAWYER
        )
    ...
    async def create_user_lawyer_message(
        self, user_id: int, content: str, document_url: str
    ) -> Message:
        """
    ...
    async def create_lawyer_response_message(
        self, user_id: int, lawyer_id: int, content: str
    ) -> Message:
        """
    ...
    async def update_message_status(
        self, message_id: int, status: MessageStatusEnum
    ) -> bool:
        """
